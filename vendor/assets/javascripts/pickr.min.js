    ...
    function (t, e, o) {
      ...
      function j(t = 0, e = 0, o = 0, n = 1) {
        const i = (t, e) => (o = -1) =>
          ...
          r = {
            ...
            toHEXA() {
              const t = (function (t, e, o) {
                  return _(t, e, o).map((t) =>
                    g(t).toString(16).padStart(2, "0")
                  );
                })(r.h, r.s, r.v),
                e =
                  r.a >= 1
            ...
            _tapmove(t) {
              ...
              if (t) {
                ...
                (c = t ? (e || t).clientX : 0),
                  ...
                  l < a.top
                    ? (l = a.top)
                    : l > a.top + a.height && (l = a.top + a.height),
                  (c -= a.left),
                  (l -= a.top);
              } else n && ((c = n.x * a.width), (l = n.y * a.height));
              "h" !== i &&
                (r.style.left = "calc("
                  .concat((c / a.width) * 100, "% - ")
                  .concat(r.offsetWidth / 2, "px)")),
                "v" !== i &&
                  (r.style.top = "calc("
                    .concat((l / a.height) * 100, "% - ")
        ...
        return {
          update(s, a = !1) {
            ...
            a
              ...
              : ((t.style.left = b.left), (t.style.top = b.top));
          },
        };
      }
      function B(t, e, o) {
      ...
      class D {
        constructor(t) {
          ...
          (this._nanopop = P({ reference: u, padding: s, el: h })),
            ...
            const {
              ...
              l = u(
                '\n      <div :ref="root" class="pickr">\n\n        '
                  ...
                  .concat(
                    a(Object.keys(e.interaction).length),
              ...
              p = l.interaction;
            return (
              p.options.find((t) => !t.hidden && !t.classList.add("active")),
              (p.type = () =>
                p.options.find((t) => t.classList.contains("active"))),
              l
            );
          })(this)),
                ...
                onchange(o, n) {
                  ...
                  (this.element.style.background = p),
                    (this.wrapper.style.background = "\n                        linear-gradient(to top, rgba(0, 0, 0, "
                      ...
                      .concat(i.a, "))\n                    ")),
                    a.comparison
                      ? a.useAsButton || t._lastColor || (c.style.color = p)
            ...
            const { _swatchColors: t, _root: o } = this,
              ...
              i = p(
                '<button type="button" style="color: '
                  .concat(n.toRGBA().toString(0), '" aria-label="')
